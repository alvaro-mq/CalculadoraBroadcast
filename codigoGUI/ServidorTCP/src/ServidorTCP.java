...
public class ServidorTCP extends Thread{
	...
	public void run(){
		try {
			...
			VentanaServidorTCP.areaPeticiones.append("- SERVIDOR TCP INICIADO -\n");
			VentanaServidorTCP.areaPeticiones.append("- Esperando Cliente -\n");
			while(true){
				...
				VentanaServidorTCP.areaPeticiones.append("**************SOLICITUD************\n");
				VentanaServidorTCP.areaPeticiones.append("Solicitud del Cliente:\n ip mascara:"+mensajeSolicitud+"\n");
				String resultado = "";
				...
				VentanaServidorTCP.areaPeticiones.append("Respuesta a cliente:\n"+ mensajeRespuesta+"\n");
